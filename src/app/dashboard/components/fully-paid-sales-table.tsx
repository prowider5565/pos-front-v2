...
import type { FullyPaidSale } from "@/types/analytics"
import type { DateFilterParams } from "./dashboard-filter"
import { useFullyPaidSales } from "@/hooks/use-analytics"
...
interface FullyPaidSalesTableProps {
  filterParams?: DateFilterParams
}

const createColumns = (t: any): ColumnDef<FullyPaidSale>[] => [
  {
...
export function FullyPaidSalesTable({ filterParams }: FullyPaidSalesTableProps) {
  ...
  if (isError) {
    return (
      <div className="text-center py-8 text-muted-foreground">
        Failed to load fully paid sales
      </div>
    )
  }
